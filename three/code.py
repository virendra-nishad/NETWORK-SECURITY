...
dataset = pd.read_csv(file_path, sep=",", header=None, names=feature)
...
dos = dict.fromkeys(["back.", "land.", "neptune.", "pod.", "teardrop.", "smurf."], "dos.")
r2l = dict.fromkeys(["ftp_write.", "guess_passwd.",
                     "imap.", "multihop.", "phf.", "spy.", "warezclient.", "warezmaster."], "r2l.")
u2r = dict.fromkeys(["buffer_overflow.", "loadmodule.", "perl.", "rootkit."], "u2r.")
...
dataset.iloc[:, 41] = dataset.iloc[:, 41].replace(col41)
# print(dataset['col_41'].value_counts())


# labelencoder_X = LabelEncoder()
# dataset['col_1'] = labelencoder_X.fit_transform(dataset['col_1'])
# dataset['col_2'] = labelencoder_X.fit_transform(dataset['col_2'])
# dataset['col_3'] = labelencoder_X.fit_transform(dataset['col_3'])
# print(dataset.head())
